function [] = lynxServo(th1, th2, th3, th4, th5, th6, th7)
...
nargin;
    ...
    lowerLim = [-1.57 -1.57 -1.57 -1.57 -1.57 -1.57 -1.57]; % Lower joint limits in radians (grip in inches)
    upperLim = -lowerLim; % Upper joint limits in radians (grip in inches)
...
%     end
    ...
    if lynx.hardware
        ...
        lynxServoPhysical(q(1),q(2),q(3),q(4),q(5),q(6),q(7));
        
    else
        lynxServoSim(q(1),q(2),q(3),q(4),q(5),q(6),q(7));
    end
